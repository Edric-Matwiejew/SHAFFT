...
static const char* hipfft_error_string(hipfftResult_t result) {
  switch (result) {
    ...
    default:                    return "HIPFFT_UNKNOWN_ERROR";
  }
}
#endif
...
int shafft_last_error_status(void)      { return g_status; }
int shafft_last_error_source(void)      { return g_source; }
int shafft_last_error_domain_code(void) { return g_code; }
...
const char* shafft_error_source_name(int source) {
  switch (static_cast<shafft_errsrc_t>(source)) {
    case SHAFFT_ERRSRC_NONE:   return "SHAFFT";
    case SHAFFT_ERRSRC_MPI:    return "MPI";
    case SHAFFT_ERRSRC_HIP:    return "HIP";
    case SHAFFT_ERRSRC_HIPFFT: return "hipFFT";
    case SHAFFT_ERRSRC_FFTW:   return "FFTW";
    case SHAFFT_ERRSRC_SYSTEM: return "System";
